...
# @Last Modified time: 2018-11-08 19:24:44
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='nyu2_cluster_no_mask')
    ...
    if args.resume is not None:
        if os.path.isfile(args.resume):
            ...
            best_error=checkpoint['error']+0.5
            print(best_error)
            print(trained)
        ...
        rsn=torch.load('/home/lidong/Documents/RSCFN/no_mask_rsn_cluster_nyu2_3_0.5482142_coarse_best_model.pkl',map_location='cpu')
        model_dict=model.state_dict()  
        #print(model_dict)          
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        if epoch%check==0:
            ...
            if error<= best_error:
                ...
                torch.save(state, "no_mask_{}_{}_{}_{}_coarse_best_model.pkl".format(
        ...
        if epoch%3==0:
            ...
            state = {'epoch': epoch+1,
                     ...
                     'optimizer_state': optimizer.state_dict(), 
                     'error': error,}
            torch.save(state, "no_mask_{}_{}_{}_coarse_model.pkl".format(
                args.arch, args.dataset,str(epoch)))
            print('save success')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default=None,
                        help='Path to previous saved model to restart from /home/lidong/Documents/RSCFN/cluster_fused_rsn_cluster_nyu2_2_0.55366516_coarse_best_model.pkl')
