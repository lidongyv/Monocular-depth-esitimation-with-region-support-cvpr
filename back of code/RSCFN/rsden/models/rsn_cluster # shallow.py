...
# @Last Modified time: 2018-12-26 22:13:34
...
class rsn_cluster(nn.Module):
    ...
    def __init__(self, 
        ...
        self.regress1 = conv2DGroupNormRelu(in_channels=64, k_size=3, n_filters=128,
                                                  padding=1, stride=1, bias=False,group_dim=group_dim)
        ...
        self.inrefine4= conv2DRelu(in_channels=16, k_size=1, n_filters=8,
                                                 padding=0, stride=1, bias=False)
        self.inrefine5= conv2DRelu(in_channels=8, k_size=1, n_filters=1,
                                                 padding=0, stride=1, bias=False)
    ...
    def forward(self, x,segments,labels,flag,task):
        ...
        if flag==0:
            ...
            # x_fuse=torch.cat([initial_depth,x1],1)
