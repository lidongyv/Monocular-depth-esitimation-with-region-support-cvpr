...
# @Last Modified time: 2018-10-29 10:54:00
...
class rsn_cluster(nn.Module):
    ...
    def __init__(self, 
        ...
        block=BasicBlock
        # Encoder
        self.conv1=conv2DGroupNormRelu(5, 32, k_size=3,
                                                padding=1, stride=1, bias=False)
        self.conv2=conv2DGroupNormRelu(32, 64, k_size=3,
                                                padding=1, stride=1, bias=False)       
        self.layer1 = self._make_layer(block, 64, layers[0],stride=1)
        # self.full1=conv2DGroupNormRelu(in_channels=32, k_size=3, n_filters=32,
        #                                         padding=1, stride=1, bias=False,dilation=1,group_dim=group_dim)
        # self.full2=conv2DGroupNormRelu(in_channels=32, k_size=3, n_filters=32,
        #                                         padding=1, stride=1, bias=False,dilation=1,group_dim=group_dim)
        ...
        self.regress1 = self._make_layer(block, 128, 3, stride=1)
        # self.regress0 = conv2DGroupNormRelu(in_channels=64, k_size=3, n_filters=64,
        #                                          padding=1, stride=1, bias=False,group_dim=group_dim)                                                       
        ...
        self.regress3 = conv2DGroupNormRelu(in_channels=64, k_size=3, n_filters=32,
                                                 padding=1, stride=1, bias=False,group_dim=group_dim) 
        # self.regress4 = conv2DGroupNormRelu(in_channels=16, k_size=3, n_filters=8,
        #                                  padding=1, stride=1, bias=False,group_dim=8) 
        self.regress4 = conv2DRelu(in_channels=32, k_size=3, n_filters=1,
                                         padding=1, stride=1, bias=False)
        self.class0= conv2DGroupNormRelu(in_channels=256, k_size=1, n_filters=128,
        ...
        self.outrefine1=conv2DGroupNormRelu(in_channels=512, k_size=1, n_filters=128,
                                                 padding=0, stride=1, bias=False,group_dim=group_dim)
        ...
        self.outrefine3=conv2DRelu(in_channels=64, k_size=3, n_filters=32,
                                                 padding=1, stride=1, bias=False)
        self.outrefine4= conv2DRelu(in_channels=32, k_size=1, n_filters=1,
                                                 padding=0, stride=1, bias=False)
        self.inrefine1=conv2DGroupNormRelu(in_channels=256, k_size=3, n_filters=128,
                                                 padding=1, stride=1, bias=False,group_dim=group_dim)
        ...
        self.inrefine4= conv2DRelu(in_channels=32, k_size=1, n_filters=16,
                                                 padding=0, stride=1, bias=False)
        self.inrefine5= conv2DRelu(in_channels=16, k_size=1, n_filters=1,
                                                 padding=0, stride=1, bias=False)
