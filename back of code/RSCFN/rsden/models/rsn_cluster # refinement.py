...
# @Last Modified time: 2018-12-16 20:12:51
...
class rsn_cluster(nn.Module):
    ...
    def __init__(self, 
        ...
        #                                          padding=0, stride=1, bias=False)
        self.inrefine1=conv2DGroupNormRelu(in_channels=129, k_size=3, n_filters=65,
                                                 padding=1, stride=1, bias=False,group_dim=65)
        self.inrefine2=conv2DGroupNormRelu(in_channels=65, k_size=3, n_filters=33,
                                                 padding=1, stride=1, bias=False,group_dim=33)
        self.inrefine3=conv2DGroupNormRelu(in_channels=33, k_size=3, n_filters=17,
                                                 padding=1, stride=1, bias=False,group_dim=17)
        self.inrefine4= conv2D(in_channels=17, k_size=1, n_filters=1,
                                                 padding=0, stride=1, bias=False)
