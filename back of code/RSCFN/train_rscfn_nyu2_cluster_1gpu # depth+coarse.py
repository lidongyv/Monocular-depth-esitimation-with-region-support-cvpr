...
# @Last Modified time: 2018-11-05 11:03:26
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='nyu2_cluster_fused')
    ...
    if args.resume is not None:
        ...
        rsn=torch.load('/home/lidong/Documents/RSCFN/rsn_cluster_nyu2_67_0.57746255coarse_best_model',map_location='cpu')
        model_dict=model.state_dict()  
        #print(model_dict)          
