...
# @Last Modified time: 2018-10-31 17:12:46
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.resume is not None:
        ...
        rsn=torch.load('/home/lidong/Documents/RSCFN/region_refine.pkl',map_location='cpu')
        model_dict=model.state_dict()  
        #print(model_dict)          
        ...
        if epoch%check==0:
            ...
            for i_val, (images_val, labels_val,regions,segments,image) in tqdm(enumerate(valloader)):
                ...
                with torch.no_grad():
                    ...
                    depth,accurate = model(images_val,regions_val,0,'eval')
