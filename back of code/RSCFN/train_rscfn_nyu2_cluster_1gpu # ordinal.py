...
# @Last Modified time: 2018-11-20 01:00:28
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='nyu_ordinal')
    ...
    if args.resume is not None:
        ...
        rsn=torch.load('/home/lidong/Documents/RSCFN/mask_volume_rsn_cluster_nyu_75_0.85421723_coarse_best_model.pkl',map_location='cpu')
        model_dict=model.state_dict()  
        #print(model_dict)          
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        if epoch%check==0:
            ...
            if error<= best_error:
                ...
                torch.save(state, "ordinal_{}_{}_{}_{}_coarse_best_model.pkl".format(
                    args.arch, args.dataset,str(epoch),str(error)))
                print('save success')
            np.save('/home/lidong/Documents/RSCFN/loss.npy',loss_rec)
        ...
        if epoch%3==0:
            ...
            state = {'epoch': epoch+1,
                     ...
                     'optimizer_state': optimizer.state_dict(), 
                     'error': error,}
            torch.save(state, "ordinal_{}_{}_{}_coarse_model.pkl".format(
                args.arch, args.dataset,str(epoch)))
            print('save success')
