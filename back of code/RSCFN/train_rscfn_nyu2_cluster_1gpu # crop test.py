...
# @Last Modified time: 2018-12-23 16:14:53
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='nyu_proup_depth')


        proup_depth_window = vis.image(
    ...
    if args.resume is not None:
        ...
        rsn=torch.load('/home/lidong/Documents/RSCFN/proup_depth_rsn_cluster_nyu_57_0.67226315_coarse_best_model.pkl',map_location='cpu')
        model_dict=model.state_dict()  
        #print(model_dict)          
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        for i, (images, labels,regions,segments,image) in enumerate(trainloader):
            ...
            if (i+1)%(train_len//2)==0:
                ...
                if error<= best_error:
                    ...
                    torch.save(state, "proup_depth_{}_{}_{}_{}_coarse_best_model.pkl".format(
        ...
        if epoch%3==0:
            ...
            state = {'epoch': epoch+1,
                     ...
                     'optimizer_state': optimizer.state_dict(), 
                     'error': error,}
            torch.save(state, "proup_depth_{}_{}_{}_ceoarse_model.pkl".format(
                args.arch, args.dataset,str(epoch)))
            print('save success')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/home/lidong/Documents/RSCFN/proup_depth_rsn_cluster_nyu_35_0.6168086_coarse_best_model.pkl',
                        help='Path to previous saved model to restart from /home/lidong/Documents/RSCFN/proup_depth_rsn_cluster_nyu_22_0.6179857_coarse_best_model.pkl')
