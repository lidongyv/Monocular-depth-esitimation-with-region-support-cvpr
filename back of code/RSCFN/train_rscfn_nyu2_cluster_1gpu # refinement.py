...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='nyu_inrefine_depth_')


        inrefine_depth_window = vis.image(
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        for i, (images, labels,regions,segments,image) in enumerate(trainloader):
            ...
            if (i+1)%(train_len//2)==0:
                ...
                if error<= best_error:
                    ...
                    torch.save(state, "inrefine_depth_{}_{}_{}_{}_coarse_best_model.pkl".format(
        ...
        if epoch%3==0:
            ...
            state = {'epoch': epoch+1,
                     ...
                     'optimizer_state': optimizer.state_dict(), 
                     'error': error,}
            torch.save(state, "inrefine_depth_{}_{}_{}_coarse_model.pkl".format(
                args.arch, args.dataset,str(epoch)))
            print('save success')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default=None,
                        help='Path to previous saved model to restart from /home/lidong/Documents/RSCFN/inrefine_depth_rsn_cluster_nyu_43_0.7498353_coarse_best_model.pkl')
