...
# @Last Modified time: 2018-11-06 21:00:18
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='nyu2_ground_fused_cluster')
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        if epoch%check==0:
            ...
            if error<= best_error:
                ...
                torch.save(state, "cluster_fused_{}_{}_{}_{}_coarse_best_model.pkl".format(
        ...
        if epoch%3==0:
            ...
            state = {'epoch': epoch+1,
                     ...
                     'optimizer_state': optimizer.state_dict(), 
                     'error': error,}
            torch.save(state, "cluster_fused_{}_{}_{}_coarse_model.pkl".format(
                args.arch, args.dataset,str(epoch)))
            print('save success')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/home/lidong/Documents/RSCFN/norm_rsn_cluster_nyu2_84_0.6576114_coarse_best_model.pkl',
