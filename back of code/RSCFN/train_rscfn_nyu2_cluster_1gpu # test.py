...
# @Last Modified time: 2018-12-26 14:31:34
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.resume is not None:
        ...
        rsn=torch.load('/home/lidong/Documents/RSCFN/proup_depth_rsn_cluster_nyu_36_0.59682584_coarse_best_model.pkl',map_location='cpu')
        model_dict=model.state_dict()  
        #print(model_dict)          
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        for i, (images, labels,regions,segments,image) in enumerate(trainloader):
            ...
            while(True):
                ...
                # if i==0:
                #     mean_loss=lin.item()
                if lin<=mean_loss or iterative_count>20:
                    mean_loss_ave.append(lin.item())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default=None,
                        help='Path to previous saved model to restart from /home/lidong/Documents/RSCFN/proup_refine_rsn_cluster_nyu_0_0.6026653_coarse_best_model.pkl')
